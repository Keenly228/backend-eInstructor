# Generated by Django 4.2.7 on 2024-11-01 21:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_totoal', models.DecimalField(decimal_places=2, default=0.0, max_digits=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('initial_total', models.DecimalField(decimal_places=2, default=0.0, max_digits=12)),
                ('saved', models.DecimalField(decimal_places=2, default=0.0, max_digits=12)),
                ('applied_cupon', models.BooleanField(default=False)),
                ('oid', shortuuid.django_fields.ShortUUIDField(alphabet='1234567890', length=6, max_length=20, prefix='', unique=True)),
                ('date', models.DateTimeField(default=django.utils.timezone.now)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(choices=[('Ukrainian', 'Ukrainian'), ('English', 'English')], default='Ukrainian', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prview', models.BooleanField(default=False)),
